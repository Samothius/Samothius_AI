...
class DatabaseManager:
    ...
    DEFAULT_SETTINGS = [
        ...
        ("boss_hp_min", "700", "int", "boss", "Minimum boss HP"),
        ("boss_hp_max", "1200", "int", "boss", "Maximum boss HP"),
        ("boss_legendary_chance", "0.20", "float", "boss", "Chance a spawned boss is Legendary (0-1)"),
        ("boss_legendary_hp_multiplier", "1.5", "float", "boss", "HP multiplier applied to Legendary bosses"),
        ("boss_max_attacks_per_user", "3", "int", "boss", "Max !attack uses per player per boss fight"),
        ("boss_miss_chance", "0.15", "float", "boss", "Chance an !attack roll is a Miss (0 damage)"),
        ("boss_crit_chance", "0.15", "float", "boss", "Chance an !attack roll is a Critical Hit (2x damage)"),
        ("boss_dmg_min", "80", "int", "boss", "Minimum damage on a Normal Hit (Crit doubles this roll)"),
        ("boss_dmg_max", "160", "int", "boss", "Maximum damage on a Normal Hit (Crit doubles this roll)"),
        ("boss_victory_reward", "15000", "int", "boss", "SamoBit per attacker when a normal boss is defeated in time"),
        ("boss_legendary_victory_reward", "22500", "int", "boss", "SamoBit per attacker when a Legendary boss is defeated in time"),
        ("boss_defeat_fee", "10000", "int", "boss", "SamoBit maintenance fee per attacker if the boss survives the timer"),
        ("auto_boss_min_chatters", "3", "int", "boss", "Minimum unique chatters required to auto-spawn a boss"),
        ("auto_boss_interval_min_minutes", "30", "int", "boss", "Minimum minutes between auto-spawn checks"),
        ("auto_boss_interval_max_minutes", "60", "int", "boss", "Maximum minutes between auto-spawn checks"),
